...
const formattedOptions = options.map(item => ( {
	...
	return {
	value: savedValue, text: termName
}
...
// For non-taxonomy endpoints, add saved values as options so Tom Select can display them.
	...
	value: savedValue, text: savedValue
}
...
;
	...
	// console.log('Parsed custom config:', customConfig);
	// Debug log
}
...
// Default config
	...
	plugins: ['dropdown_input', 'clear_button', 'remove_button'],
                ...
                create: false,
                render: {
	no_results: (data, escape) => `<div class="no-results">$ {
